  ...
  return (
    <section className='flex flex-col items-center justify-start gap-4 pt-20 cursor-default section'>
      ...
      <div className='relative h-[15vh] mt-20 dt:mr-20'>
        <motion.div
          className='absolute inset-x-0 w-1 h-0 -inset-y-5 bg-onyx'
        ...
        />
        <motion.span
          className='inset-y-[12.5vh] -inset-x-[0.75rem] w-7 h-7 rounded-full absolute bg-onyx'
          initial={{
            scale: 0,
          }}
          whileInView={{
      ...
      <div className='flex flex-col items-center gap-2 dt:mr-20'>
        ...
        <motion.p
          className='text-[1.5rem] leading-[150%] pt-3 italic text-center max-w-[44rem] text-onyx'
          initial={{
            opacity: 0,
            y: '-10%',
          }}
